...
public class ProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvProfileGrade = findViewById(R.id.tvProfileGrade); // ✅ تأكدي أن هذا الـ ID موجود في activity_profile.xml
        ...
        api.getUser(userId).enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (tvProfileGrade != null) tvProfileGrade.setText(user.getGrade());
                }
            }
